          ...
          <div className="swiper-wrapper">
            ...
            {slideData.map((slide, index) => (
              <div className="new__content-bg tw-relative tw-w-[242px] tw-pt-8 tw-pb-6 tw-px-0 tw-rounded-xl 
                ...
                <h3 className="tw-text-[.938rem] large:tw-text-[1.25rem] tw-font-medium">{slide.title}</h3>
                <span className="tw-block tw-text-[.813rem] tw-mb-[.5rem] large:tw-mb-[1rem]">{slide.subtitle}</span>

                <div className="tw-inline-flex tw-items-center tw-gap-2">
                  <span className="tw-font-medium tw-text-white">{slide.price}</span>
                  <span className="tw-text-[#F4511F] tw-text-[.75rem] tw-line-through tw-font-medium">{slide.discount}</span>
                </div>
                ...
                <button className="tw-inline-flex tw-bg-[#F4511F] hover:tw-bg-[#F4420B] tw-text-white 
                  ...
                  <i className="bx bx-cart-alt tw-text-[1.25rem]"></i>
                </button>
              </div>
            ))}
          </div>
